...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("홍미미", 21, "서울시 용산구");
    studentService.saveStudent(studentInfoDto);
    studentService.saveStudent(studentInfoDto1);

    CourseInfoDto courseInfoDto = new CourseInfoDto("첼로", 100000, "MONDAY", "홍길동", 1717299008L);
    CourseInfoDto courseInfoDto1 = new CourseInfoDto("바순", 150000, "MONDAY", "홍미미", 1717299008L);
